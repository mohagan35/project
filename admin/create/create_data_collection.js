...
var output = "";
var html1 = "<!doctype html><html><head><title>";
var html2 = "</title> \
        ...
        <script>";
var html3 = "</script><link href='js/jspsych/css/jspsych.css' rel='stylesheet' type='text/css'></link> \
    </head><body id='body' ";
var html4 = "></body><script>var assets = [";
var html5 = "jsPsych.preloadImages(assets, function(){ startExperiment(); }, function(nLoaded) { updateLoadedCount(nLoaded); });\
    function updateLoadedCount(nLoaded){\
        document.getElementById(\"body\").innerHTML = '' + nLoaded + ' of ' + assets.length + ' assets loaded.';\
    }\
    jsPsych.init({ \
...
function addAsset(str) {
    "use strict";
    if (html4.indexOf(str) === -1) {
        if (html4.charAt(html4.length - 2) === ';') {
            html4 = html4.substr(0, html4.length - 2);
        }
...
function generateIntroBlock(name) {
    ...
    if (document.getElementById(name + "_instructions_audio_check").checked) {
        str += "<audio hidden autoplay>" +
            "<source src=\"assets/" + makeStringSafe(document.getElementById(name + "_instructions_audio_file").value.split(/(\\|\/)/g).pop()) + "\"></audio><p>";
        addAsset("assets/" + makeStringSafe(document.getElementById(name + "_instructions_audio_file").value.split(/(\\|\/)/g).pop()));
    }
    if (document.getElementById(name + "_instructions_image_check").checked) {
        ...
        addAsset("assets/" + makeStringSafe(document.getElementById(name + "_instructions_image_file").value.split(/(\\|\/)/g).pop()));
    }
    ...
    if (document.getElementById(name + "_feedback_none").checked) {
        ...
        if (document.getElementById(name + "_feedback_correct").checked) {
            ...
            if (document.getElementById(name + "_feedback_audio_check").checked) {
                str += "<audio hidden autoplay>" +
                    "<source src=\"assets/" + makeStringSafe(document.getElementById(name + "_feedback_correct_audio_file").value.split(/(\\|\/)/g).pop()) + "\"></audio>";
                addAsset("assets/" + makeStringSafe(document.getElementById(name + "_feedback_correct_audio_file").value.split(/(\\|\/)/g).pop()));
            }
            if (document.getElementById(name + "_feedback_image_check").checked) {
                ...
                addAsset("assets/" + makeStringSafe(document.getElementById(name + "_feedback_correct_image_file").value.split(/(\\|\/)/g).pop()));
            }
            str += "', ";
        } else {
            str += "correct_text: '', ";
        ...
        if (document.getElementById(name + "_feedback_incorrect").checked) {
            ...
            if (document.getElementById(name + "_feedback_audio_check").checked) {
                str += "<audio hidden autoplay>" +
                    "<source src=\"assets/" + makeStringSafe(document.getElementById(name + "_feedback_incorrect_audio_file").value.split(/(\\|\/)/g).pop()) + "\"></audio>";
                addAsset("assets/" + makeStringSafe(document.getElementById(name + "_feedback_incorrect_audio_file").value.split(/(\\|\/)/g).pop()));
            }
            if (document.getElementById(name + "_feedback_image_check").checked) {
                str += "<img src=\"assets/" + makeStringSafe(document.getElementById(name + "_feedback_incorrect_image_file").value.split(/(\\|\/)/g).pop()) + "\">";
                addAsset("assets/" + makeStringSafe(document.getElementById(name + "_feedback_incorrect_image_file").value.split(/(\\|\/)/g).pop()));
            }
            str += "',";
        } else {
            str += "incorrect_text: '', ";
        ...
        if (document.getElementById(name + "_feedback_slow").checked) {
            ...
            if (document.getElementById(name + "_feedback_audio_check").checked) {
                str += "<audio hidden autoplay>" +
                    "<source src=\"assets/" + makeStringSafe(document.getElementById(name + "_feedback_slow_audio_file").value.split(/(\\|\/)/g).pop()) + "\"></audio>";
                addAsset("assets/" + makeStringSafe(document.getElementById(name + "_feedback_slow_audio_file").value.split(/(\\|\/)/g).pop()));
            }
            if (document.getElementById(name + "_feedback_image_check").checked) {
                str += "<img src=\"assets/" + makeStringSafe(document.getElementById(name + "_feedback_slow_image_file").value.split(/(\\|\/)/g).pop()) + "\">";
                addAsset("assets/" + makeStringSafe(document.getElementById(name + "_feedback_slow_image_file").value.split(/(\\|\/)/g).pop()));
            }
            str += "',";
        }
...
function generateExampleTestBlock() {
    ...
    if (document.getElementById("Example_feedback_neither").checked) {
        str = "var Example_test_block = {" +
                                ...
                                "choices: [" + keyChoices[0] + ", " + keyChoices[1] + "]," +
                                "correct_text: '<script>document.getElementById(\"audioExample\").pause();</scr\' + \'ipt>'," +
                                "incorrect_text: '<script>document.getElementById(\"audioExample\").pause();</scr\' + \'ipt>'," +
                                "is_html: true };\n";
        ...
        if (document.getElementById("Example_feedback_correct").checked) {
            str += "correct_text: '<script>document.getElementById(\"audioExample\").pause();</scr\' + \'ipt>";
            if (document.getElementById("Example_feedback_audio_check").checked) {
                str += "<audio hidden autoplay>" +
                    "<source src=\"assets/" + makeStringSafe(document.getElementById("Example_feedback_correct_audio_file").value.split(/(\\|\/)/g).pop()) + "\"></audio>";
                addAsset("assets/" + makeStringSafe(document.getElementById("Example_feedback_correct_audio_file").value.split(/(\\|\/)/g).pop()));
            }
            if (document.getElementById("Example_feedback_image_check").checked) {
                ...
                addAsset("assets/" + makeStringSafe(document.getElementById("Example_feedback_correct_image_file").value.split(/(\\|\/)/g).pop()));
            }
            ...
            str += "correct_text: '<script>document.getElementById(\"audioExample\").pause();</scr\' + \'ipt>', incorrect_text: '<script>document.getElementById(\"audioExample\").pause();</scr\' + \'ipt>";
            if (document.getElementById("Example_feedback_audio_check").checked) {
                str += "<audio hidden autoplay>" +
                    "<source src=\"assets/" + makeStringSafe(document.getElementById("Example_feedback_incorrect_audio_file").value.split(/(\\|\/)/g).pop()) + "\"></audio>";
                addAsset("assets/" + makeStringSafe(document.getElementById("Example_feedback_incorrect_audio_file").value.split(/(\\|\/)/g).pop()));
            }
            if (document.getElementById("Example_feedback_image_check").checked) {
                str += "<img src=\"assets/" + makeStringSafe(document.getElementById("Example_feedback_incorrect_image_file").value.split(/(\\|\/)/g).pop()) + "\">";
                addAsset("assets/" + makeStringSafe(document.getElementById("Example_feedback_incorrect_image_file").value.split(/(\\|\/)/g).pop()));
            }
            str += "',";
...
function generateExamplesJS() {
    ...
    for (i = 1; i <= trialsNum; i += 1) {
        stimImagesJS += "'<audio id=\"audioExample\" hidden autoplay>" +
            "<source src=\"assets/" + makeStringSafe(document.getElementById("Example_trial_file_" + i).value.split(/(\\|\/)/g).pop()) + "\"></audio>" +
        ...
        addAsset("assets/" + makeStringSafe(document.getElementById("Example_trial_file_" + i).value.split(/(\\|\/)/g).pop()));
        addAsset("assets/" + makeStringSafe(document.getElementById("General_stim_file_" + (document.getElementById("Example_trial_select_stim_" + i).selectedIndex + 1)).value.split(/(\\|\/)/g).pop()));
...
function createTest() {
    ...
    */
    if (document.getElementById("General_background_image_file")) {
        ...
        addAsset("assets/" + makeStringSafe(document.getElementById("General_background_image_file").value.split(/(\\|\/)/g).pop()));
    }
    ...
    */
    if (document.getElementById("page_2_container")) {
        ...
        if (document.getElementById("Introduction_instructions_audio_check").checked) {
            pagesJS += "<audio hidden autoplay>" +
                "<source src=\"assets/" + makeStringSafe(document.getElementById("Introduction_instructions_audio_file").value.split(/(\\|\/)/g).pop()) + "\"></audio><p>";
            addAsset("assets/" + makeStringSafe(document.getElementById("Introduction_instructions_audio_file").value.split(/(\\|\/)/g).pop()));
        }
        if (document.getElementById("Introduction_instructions_image_check").checked) {
            ...
            addAsset("assets/" + makeStringSafe(document.getElementById("Introduction_instructions_image_file").value.split(/(\\|\/)/g).pop()));
        }
    ...
    while (document.getElementById("page_" + i + "_container")) {
        ...
        if (document.getElementById("Introduction_instructions_audio_check_" + i).checked) {
            pagesJS += "<audio hidden autoplay>" +
                "<source src=\"assets/" + makeStringSafe(document.getElementById("Introduction_instructions_audio_" + i + "_file").value.split(/(\\|\/)/g).pop()) + "\"></audio><p>";
            addAsset("assets/" + makeStringSafe(document.getElementById("Introduction_instructions_audio_" + i + "_file").value.split(/(\\|\/)/g).pop()));
        }
        if (document.getElementById("Introduction_instructions_image_check_" + i).checked) {
            ...
            addAsset("assets/" + makeStringSafe(document.getElementById("Introduction_instructions_image_" + i + "_file").value.split(/(\\|\/)/g).pop()));
        }
    ...
    */
    output = html1 + document.getElementById("Submit_input_textline_folder").value + html2 + outputJS + html3 + html4 + html5;
